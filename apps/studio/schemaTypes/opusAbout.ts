...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'text',
      description:
        'Intro paragraph(s) under the About heading. Leave a blank line to start a new paragraph. Wrap words in **double asterisks** to bold them and *single asterisks* to italicize them.',
      validation: (Rule) => [
